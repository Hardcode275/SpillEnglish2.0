      ...
      <div className="w-full md:w-[800px] xl:w-[900px] flex flex-col justify-center items-center pt-16 md:pt-16 lg:pt-20 text-center">
        ...
        >
          <div className="text-5xl sm:text-6xl lg:text-7xl xl:text-7xl font-bold tracking-wide text-primaryText px-8 sm:px-8 md:px-20 lg:px-4">
            <h1 className="inline md:hidden">Spill the English</h1>
            <h1 className="hidden md:inline">Your English learning podcast</h1>
          </div>
        ...
        >
          <h2 className="text-secondaryText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-48">
            Tune in weekly to improve your listening, boost your vocabulary, and enjoy real-life conversations in English.
          </h2>
        </motion.div>
        <motion.div
          initial={{ opacity: 0, y: 10 }}
        ...
        >
          <div className="flex flex-col gap-2 sm:flex-row mt-14 mb-24 sm:mb-40 justify-center">
            <a
              ...
              className="contained-button w-64 sm:w-52 h-12 mr-0 sm:mr-4 lg:mr-6 mb-2 sm:mb-0 flex justify-center items-center"
        ...
        >
          <div className="relative w-screen flex justify-center">
            <img
              src={"./src/assets/images/podcast2.jpg"}
              alt="Spill the English podcast preview"
              className="w-4/7 2xl:w-[120px] mx-auto absolute z-10 rounded-xl main-border-gray hero-dashboard-border-gradient lg:top-0 xl:top-0"
            />
          </div>
        </motion.div>
        <div className="relative w-screen flex justify-center">
