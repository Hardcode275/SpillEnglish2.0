...
import { TailcastLogo } from "../assets/logos/TailcastLogo"; // Cambiar si ya tenés el logo nuevo
...
export const InvitationModal = ({ setIsOpen }) => (
  <AnimatePresence>
    ...
    >
      ...
      >
        <div
          className="w-full h-screen sm:h-auto sm:w-3/4 md:w-3/5 lg:w-[1000px] xl:w-[1100px] sm:rounded-2xl bg-bgDarkTransparentLighter main-border-gray-darker py-12 px-8 sm:px-16 backdrop-blur-xl fixed mx-auto z-50"
          ...
          <div className="flex relative">
            ...
            <div className="w-1/2 hidden lg:inline">
              ...
              <h2 className="text-5xl font-bold tracking-normal text-secondaryColor">
                Learn English Every Week
              </h2>

              <ul className="mb-6 text-primaryText mt-12">
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Real conversations with native speakers</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Weekly vocabulary & grammar tips</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Free transcripts for every episode</span>
                </li>
              </ul>
            </div>
